<#include "header.ftl">
<@header title="分类 ${category.name!} 下的文章 - ${options.blog_title!}" keywords="${options.seo_keywords!}" description="${options.seo_description!}" />
    <div id="main">
        <div class="breadcrumbs"><a href="${context!}">首页</a>
            &raquo; 分类 ${category.name!} 下的文章</div>
